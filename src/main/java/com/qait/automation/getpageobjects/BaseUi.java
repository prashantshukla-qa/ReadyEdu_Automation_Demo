...
public class BaseUi {
	...
	protected void verifyPageTitleExact(String expectedPagetitle) {
		...
		try {
			...
			logMessage("[PASS]:: PageTitle for " + pageName + " is exactly: '"
					+ expectedPagetitle + "'");
	...
	protected void verifyPageTitleContains(String expectedPagetitle) {
		...
		try {
			...
			logMessage("[FAIL]: As actual Page Title: '" + actualPageTitle
					+ "' does not contain expected Page Title : '"
					+ expectedPagetitle + "'.");
		}
		String actualPageTitle = getPageTitle().trim();
		logMessage("[PASS]: PageTitle for " + actualPageTitle + " contains: '"
				+ expectedPagetitle + "'.");
	}
